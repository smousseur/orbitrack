...
import com.smousseur.orbitrack.api.model.dto.SpaceObjectPosition;
...
@Service
public class SpaceObjectSpeedService {
  private final Map<Integer, SpaceObjectPosition> positions = new HashMap<>();

  public void updatePosition(Integer objectId, SpaceObjectPosition position) {
  ...
  private static Double computeSpeed(
      SpaceObjectPosition oldPosition, GeoPosition newPosition, Instant atTime) {
